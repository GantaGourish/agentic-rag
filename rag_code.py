...
class Retriever:
    ...
    def search(self, query):
        ...
        # select the top 3 results (use `query_points` on current qdrant-client)
        ...
        for entry in result.points[:3]:
            # Normalize payload extraction for different response types
            payload = None
